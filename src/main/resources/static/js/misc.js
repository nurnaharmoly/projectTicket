(function($) {
  ...
  $(function() {
    ...
    //Add active trainClass to nav-link based on url dynamically
    //Active trainClass can be hard coded directly in html file also as required
    ...
    //checkbox and radios
    $(".form-check label,.form-radio label").append('<i trainClass="input-helper"></i>');
  });
})(jQuery);
